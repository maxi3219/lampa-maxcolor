    ...
    function applyCustomStyles() {
        ...
        style.innerHTML = `
            @media screen and (min-width: 480px) {
                /* === Удаляем встроенные рамки и тени === */
                .card,
                .card__view,
                .card__img,
                .card__poster,
                ...
                /* === Постер: ровный, с градиентной рамкой и зазором === */
                .card__img,
                .card__poster,
                .card__view img {
    ...
    function register() {
        if (window.app && app.plugins && typeof app.plugins.add === 'function') {
            app.plugins.add({
                ...
                version: '4.2',
                author: 'maxi3219',
                description: 'Градиентная рамка с зазором + скругление и выделение всех пунктов меню',
                init: initPlugin
            });
